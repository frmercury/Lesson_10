...
public class Basketball extends SportClub {

    public Basketball(String name, String type, String owner, int numberOfPlayers, int placeInTable, String cityOfOrigin) {
    ...
    public Basketball(String name, String type, String owner) {
        super(name, type, owner);
    }
