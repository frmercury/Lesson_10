...
public class Football extends SportClub {
    ...
    public Football(String name, String type, String owner, int numberOfPlayers, int placeInTable, String cityOfOrigin) {
    ...
    public Football(String name, String type, String owner) {
        super(name, type, owner);
    }
